...
const PrivacyPolicy = () => {
  return (
    <div className="bg-white text-black min-h-screen py-12 px-6 md:px-12 lg:px-24">
      <div className="max-w-4xl mx-auto">
        {/* Tiêu đề chính */}
        <h1 className="text-3xl md:text-4xl font-bold mb-6">Privacy Policy</h1>

        {/* URL và ngày cập nhật */}
        <p className="text-gray-600 mb-8">
          <a
            href="https://www.freeprivacypolicy.com/live/af8a58b3-8efe-4c6f-a0d5-a891dc714498"
            className="underline text-blue-600"
          >
            https://www.freeprivacypolicy.com/live/af8a58b3-8efe-4c6f-a0d5-a891dc714498
          </a>
        </p>
        <p className="text-gray-600 mb-8">Privacy Policy</p>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-[#4F81BD]">
            Interpretation and Definitions
          </h2>
          <h3 className="text-xl font-medium mb-2 text-[#4F81BD]">Interpretation</h3>
          <p className="text-lg leading-relaxed">
            The words of which the initial letter is capitalized have meanings defined under the
            following conditions. The following definitions shall have the same meaning regardless
            of whether they appear in singular or in plural.
          </p>
          <h3 className="text-xl font-medium mt-6 mb-2 text-[#4F81BD]">Definitions</h3>
          <p className="text-lg leading-relaxed">For the purposes of this Privacy Policy:</p>
          <ul className="list-disc pl-6 mt-4 space-y-2 text-lg leading-relaxed">
            ...
            <li>
              <strong>Application</strong> refers to NVB Play, the software program provided by the
              Company.
            </li>
            <li>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in
              this Agreement) refers to NVB PLAY JOINT STOCK COMPANY, Số 62, Đường Lê Bình, Phường
              Hưng Lợi, Quận Ninh Kiều, Thành phố Cần Thơ, Việt Nam.
            </li>
            <li>
        ...
        <section className="mb-10">
          ...
          <h3 className="text-xl font-medium mb-2 text-[#4F81BD]">Types of Data Collected</h3>
          <h4 className="text-lg font-medium mb-2 text-[#4F81BD] italic">Personal Data</h4>
          <p className="text-lg leading-relaxed">
          ...
          <h4 className="text-lg font-medium mt-6 mb-2 text-[#4F81BD] italic">Usage Data</h4>
          <p className="text-lg leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-[#4F81BD]">Use of Your Personal Data</h2>
          <p className="text-lg leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-[#4F81BD]">Delete Your Personal Data</h2>
          <p className="text-lg leading-relaxed">
        ...
        <section className="mb-10">
          ...
          <h3 className="text-xl font-medium mb-2 text-[#4F81BD] italic">Business Transactions</h3>
          <p className="text-lg leading-relaxed">
          ...
          <h3 className="text-xl font-medium mt-6 mb-2 text-[#4F81BD] italic">Law Enforcement</h3>
          <p className="text-lg leading-relaxed">
          ...
          <h3 className="text-xl font-medium mt-6 mb-2 text-[#4F81BD] italic">
        ...
        {/* Children's Privacy */}
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-[#4F81BD]">Children's Privacy</h2>
          <p className="text-lg leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-[#4F81BD]">Links to Other Websites</h2>
          <p className="text-lg leading-relaxed">
        ...
        {/* Contact Us */}
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-[#4F81BD]">Contact Us</h2>
          <p className="text-lg leading-relaxed">
          ...
          <ul className="list-disc pl-6 mt-4 space-y-2 text-lg leading-relaxed">
            <li>
              By email:{' '}
              <a href="mailto:support@nvbplay.vn" className="underline text-blue-600">
                support@nvbplay.vn
              </a>
            </li>
            <li>
              By visiting this page on our website:{' '}
              <a href="https://support.nvbplay.vn" className="underline text-blue-600">
                https://support.nvbplay.vn
              </a>
            </li>
          </ul>
        </section>
